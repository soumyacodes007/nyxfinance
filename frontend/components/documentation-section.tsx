...
export default function DocumentationSection() {
  ...
  const cards = [
    {
      title: "1. Onboard anchor & policy",
      description: "Register anchor credentials and assign credit policy risk tiers on-chain via ParticipantPolicy.",
      image: "/modern-dashboard-interface-with-data-visualization.jpg",
    },
    {
      title: "2. Prove collateral health",
      description: "Generate a zero-knowledge proof showing your private tokenized RWA reserves cover the USDC credit draw.",
      image: "/analytics-dashboard.png",
    },
    {
      title: "3. Draw & repay USDC",
      description: "Execute the private USDC prefunding draw, run payout corridors, and repay to release locked collateral.",
  ...
  return (
    <div id="workflow" className="w-full scroll-mt-20 border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
      {/* Header Section */}
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          ...
          <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
            USDC prefunding workflow in three steps
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            Our protocol streamlines private collateral onboarding,
            <br />
            ZK-based credit draws, and automated repayment verification.
          </div>
        </div>
      </div>
            ...
            {cards.map((card, index) => {
              ...
              return (
                <div
                  ...
                  className={`w-full overflow-hidden flex flex-col justify-start items-start transition-all duration-300 cursor-pointer hover:scale-[1.01] hover:shadow-sm ${
                    isActive
                      ? "bg-white shadow-[0px_0px_0px_0.75px_#E0DEDB_inset]"
                      : "border border-[rgba(2,6,23,0.08)] hover:bg-[rgba(55,50,47,0.015)]"
                  }`}
                >
                  <div
